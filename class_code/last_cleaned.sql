...
DROP VIEW IF EXISTS SPECYEARS;

CREATE VIEW `SPECYEARS` AS
	SELECT * FROM product_sales WHERE YEAR(Date) = 2005 OR YEAR(Date)=2003 ;
    
SELECT * FROM SPECYEARS;
SELECT COUNT(*) FROM SPECYEARS;
